...
<div class="wrapper">
    ...
    <nav class="navbar navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          <a href="<?= BASEURL ?>" class="navbar-brand"><b>Kas</b>RT</a>
    ...
    <div class="container">
      <section class="content">
      	<div class="row col-sm-5">
      		...
      		<p style="margin-top: 40px;font-size: 15px">Ini adalah Sitem Pengelolaan Uang Iuran RT. <br>Untuk memanfaatkan sistem ini, Anda harus login terlebih dahulu dengan NIK anda yang sudah terdaftar dalam sistem. Jika belum memiliki akun, silahkan minta ke pengurus RT.</p><br>
      		<p style="font-size: 15px;">Selanjutnya, Anda hanya memasukkan nominal yang ingin di bayarkan untuk membayar iuran kas RT dan silahkan tunggu sampai pengurus mengkonfirmasi pembayaran uang kas Anda.</p>
      	</div>
  ...
  <footer class="main-footer">
    <div class="container">
      ...
      <strong>Copyright &copy; <?= date('Y') ?> <a href="<?= BASEURL ?>">Iuran Kas RT</a>.</strong> All rights
      reserved.
    </div>
    <!-- /.container -->
  </footer>
